...
var _freedux = __webpack_require__(12);

var _freedux2 = _interopRequireDefault(_freedux);

var _appState = __webpack_require__(13);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = _appState2.default, _temp), _possibleConstructorReturn(_this, _ret);
  }
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(_entry2.default, { path: '/entry/:id', loggedIn: loggedIn, loading: loading, entryIndex: entryIndex, entry: entry }),
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      if (this.props.loggedIn) return (0, _preactRouter.route)('/entries');
    }
  }, {
    key: 'render',
    value: function render() {
...
var Entries = function (_Component) {
  ...
  function Entries() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Entries.__proto__ || Object.getPrototypeOf(Entries)).call.apply(_ref, [this].concat(args))), _this), _this.componentWillMount = function () {
...
var Entry = function (_Component) {
  ...
  _createClass(Entry, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      if (this.props.id) (0, _fire2.default)('setEntry', { id: this.props.id })();
    }
  }, {
    key: 'getIcons',
...
var _entryActions = __webpack_require__(19);
...
var _entryService = __webpack_require__(20);
...
var getForUser = function getForUser(el) {
  el.setState({ loading: el.state.loading + 1 });
  _entryService2.default.getForUser().then(function (response) {
    el.setState(Object.assign(el.state, {
...
exports.default = { create: create, get: get, update: update, del: del, getForUser: getForUser, getAllForUser: getAllForUser, setEntry: setEntry };
...
var getForUser = function getForUser() {
  return (0, _xhr2.default)({
    url: '/api/entries'
  });
};
...
exports.default = { create: create, get: get, update: update, del: del, getForUser: getForUser, getAllForUser: getAllForUser };
